...
include "m8c.inc"
include "memory.inc"
include "SAR6_rain.inc"

;-----------------------------------------------
;  Global Symbols
;-----------------------------------------------
export  SAR6_rain_Start
export _SAR6_rain_Start
export  SAR6_rain_SetPower
export _SAR6_rain_SetPower
export  SAR6_rain_cGetSample
export _SAR6_rain_cGetSample
export  SAR6_rain_Stop
export _SAR6_rain_Stop
...
; a future release.
;-----------------------------------------------
export  SAR6_rain_GetSample
export _SAR6_rain_GetSample
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: SAR6_rain_Start
;  FUNCTION NAME: SAR6_rain_SetPower
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: SAR6_rain_cGetSample
;
;  DESCRIPTION:
...
PSOC_SAR_SIGN:         equ 20h ;
 ...
 SAR6_rain_cGetSample:
_SAR6_rain_cGetSample:
 SAR6_rain_GetSample:  ; WARNING, this label will be removed in a future release.
_SAR6_rain_GetSample:  ; WARNING, this label will be removed in a future release.
    ...
    mov  reg[SAR6_rain_CR0], SAR6_rain_CR0_INIT
    mov  reg[ASY_CR], PSOC_SAR_CTRL | SAR6_rain_SCCOL_MASK
    ...
    or   reg[SAR6_rain_CR0], 0   ; set sign & try MSB of magnitude
    or   reg[SAR6_rain_CR0], 0   ; set MSB of magnitude and try next lower
    or   reg[SAR6_rain_CR0], 0   ;                      ... and next ...
    or   reg[SAR6_rain_CR0], 0   ;                      ... and next ...
    or   reg[SAR6_rain_CR0], 0   ;                      ... and try LSB
    or   reg[SAR6_rain_CR0], 0   ; and, finally, set LSB of magnitude.
    ...
    ;; for negative values.
    mov  A, reg[SAR6_rain_CR0]
    and  A, PSOC_SAR_MAGNITUDE
    tst  reg[SAR6_rain_CR0], PSOC_SAR_SIGN
...
_SAR6_rain_Stop:
    RAM_PROLOGUE RAM_USE_CLASS_1
    and reg[SAR6_rain_CR3], ~bPWRMASK
    RAM_EPILOGUE RAM_USE_CLASS_1
    ret
.ENDSECTION

; End of File SAR6_rain.asm
