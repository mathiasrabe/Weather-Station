...
export LoadConfig_weather_station
export _LoadConfig_weather_station
...
_LoadConfigInit:
 LoadConfigInit:
	...
	mov		[Port_0_DriveMode_1_SHADE], f8h
	mov		[Port_2_Data_SHADE], 0h
	mov		[Port_2_DriveMode_0_SHADE], 7fh
	mov		[Port_2_DriveMode_1_SHADE], 80h

	lcall	LoadConfig_weather_station
	lcall	LoadConfigTBL_weather_station_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration weather_station
;
;    Load configuration registers for weather_station.
...
;               CUR_PP
;
_LoadConfig_weather_station:
 LoadConfig_weather_station:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_weather_station_Bank0
    mov     X, <LoadConfigTBL_weather_station_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_weather_station_Bank1
    mov     X, <LoadConfigTBL_weather_station_Bank1
