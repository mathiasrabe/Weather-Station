...
include "m8c.inc"
include "memory.inc"
include "SAR6_sun.inc"

;-----------------------------------------------
;  Global Symbols
;-----------------------------------------------
export  SAR6_sun_Start
export _SAR6_sun_Start
export  SAR6_sun_SetPower
export _SAR6_sun_SetPower
export  SAR6_sun_cGetSample
export _SAR6_sun_cGetSample
export  SAR6_sun_Stop
export _SAR6_sun_Stop
...
; a future release.
;-----------------------------------------------
export  SAR6_sun_GetSample
export _SAR6_sun_GetSample
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: SAR6_sun_Start
;  FUNCTION NAME: SAR6_sun_SetPower
;
;  DESCRIPTION:
...
.SECTION
;-----------------------------------------------------------------------------
;  FUNCTION NAME: SAR6_sun_cGetSample
;
;  DESCRIPTION:
...
PSOC_SAR_SIGN:         equ 20h ;
 ...
 SAR6_sun_cGetSample:
_SAR6_sun_cGetSample:
 SAR6_sun_GetSample:  ; WARNING, this label will be removed in a future release.
_SAR6_sun_GetSample:  ; WARNING, this label will be removed in a future release.
    ...
    mov  reg[SAR6_sun_CR0], SAR6_sun_CR0_INIT
    mov  reg[ASY_CR], PSOC_SAR_CTRL | SAR6_sun_SCCOL_MASK
    ...
    or   reg[SAR6_sun_CR0], 0   ; set sign & try MSB of magnitude
    or   reg[SAR6_sun_CR0], 0   ; set MSB of magnitude and try next lower
    or   reg[SAR6_sun_CR0], 0   ;                      ... and next ...
    or   reg[SAR6_sun_CR0], 0   ;                      ... and next ...
    or   reg[SAR6_sun_CR0], 0   ;                      ... and try LSB
    or   reg[SAR6_sun_CR0], 0   ; and, finally, set LSB of magnitude.
    ...
    ;; for negative values.
    mov  A, reg[SAR6_sun_CR0]
    and  A, PSOC_SAR_MAGNITUDE
    tst  reg[SAR6_sun_CR0], PSOC_SAR_SIGN
...
_SAR6_sun_Stop:
    RAM_PROLOGUE RAM_USE_CLASS_1
    and reg[SAR6_sun_CR3], ~bPWRMASK
    RAM_EPILOGUE RAM_USE_CLASS_1
    ret
.ENDSECTION

; End of File SAR6_sun.asm
